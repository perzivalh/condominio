...
import dj_database_url  # dY`^ importante para leer DATABASE_URL
...
# Database
# En local usarA� postgres con tus datos, en producciA3n Railway usa DATABASE_URL
